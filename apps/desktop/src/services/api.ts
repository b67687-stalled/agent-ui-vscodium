...
export async function gitPush(
  ...
  return fetchJson(`${API_BASE}/git/push`, {
    method: "POST",
    body: JSON.stringify({ dir, remote, branch }),
  });
}
...
export async function gitCreatePR(
  ...
  return fetchJson(`${API_BASE}/git/pr`, {
    method: "POST",
    body: JSON.stringify({ dir, title, body, base }),
  });
}

export async function getGitBranches(dir: string = "."): Promise<{
